...
ENABLE_BLOCKCHAIN = os.getenv("ENABLE_BLOCKCHAIN")
...
BLOCKCHAIN_GAS_LIMIT = os.getenv("BLOCKCHAIN_GAS_LIMIT")
BLOCKCHAIN_GAS_PRICE_MULTIPLIER = os.getenv("DIDIT_CALLBACK_URL")
CONTRACT_USER_REGISTRY = os.getenv("DIDIT_CALLBACK_URL")
CONTRACT_ACCESS_CONTROL = os.getenv("CONTRACT_ACCESS_CONTROL")
CONTRACT_SIM_SWAP_MANAGER = os.getenv("CONTRACT_SIM_SWAP_MANAGER")
